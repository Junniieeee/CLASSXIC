...
<body>
    ...
    <div class="modal fade" id="signupModal" tabindex="-" aria-labelledby="signupModalLabel" aria-hidden="true">
      <div class="modal-dialog">
		...
		<div class="modal fade" id="loginModal" tabindex="0" aria-labelledby="signupModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h1 class="modal-title typing" id="animatedText2">Sign up!</h1>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body">
							<form method="POST" enctype="multipart/form-data" action="">
					...
					<div class="">
						<p class="text-center mb-4">
							If you already have an account <a href=""data-bs-toggle="modal" data-bs-target="#signupModal">sign in here.</a>
						</p>
					</div>
				</div>
			</div>
